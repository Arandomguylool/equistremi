...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		...
		['Pico', 'Philly', "Blammed"],
		['Satin-Panties', "High", "Milf"],//Shit, seriously fuck y'all cuz I was wasting time on something that is not difficult
		['Cocoa', 'Eggnog', 'Winter-Horrorland'],//I literally wasted a whole week of my life trying to fix this
		['Senpai', 'Roses', 'Thorns'],//What I mean, is to remove every week, you can not, when I leave the QT week below the tutorial, it just crashes
		['Carefree', 'Careless', 'Censory-Superload', 'Exterminate']//So don't complain about this -Drkfon
	];
