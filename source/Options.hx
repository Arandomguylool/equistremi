...
/*
class FullScreen extends Option //This is a Work in Progress, If I get it to work, it will come in one and last update
                                 (btw, this will have a new lore for the mod)
{
	public function new(desc:String)
		{
			super();
	...
	public override function press():Bool
		{
			Main.startFullscreen = !Main.startFullscreen;
			FlxG.save.data.startFullscreen = Main.startFullscreen;
			display = updateDisplay();
			return true;
		}
		...
		private override function updateDisplay():String
		{
			return "FullScreen " + (Main.startFullscreen ? "on" : "off");
		}
}
*/
...
class QTCutsceneOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		Main.qtCutscenePlay = !Main.qtCutscenePlay;
		FlxG.save.data.qtCutscenePlay = Main.qtCutscenePlay;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "QT Cutscene " + (Main.qtCutscenePlay ? "off" : "on");
	}
}
