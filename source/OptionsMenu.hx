...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCatagory> = [
		...
		new OptionCatagory("Appearence", [
			...
			//new FullScreen("Switch to Fullscreen, It works even when you open the game"),
		...
		new OptionCatagory("Misc", [
			...
			new QTCutsceneOption("Enable or disable the cutscene between Careless and Censory-Superload")
		])
